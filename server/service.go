...
import (
	...
	"github.com/acexy/proxy/pkg/auth"
	v1 "github.com/acexy/proxy/pkg/config/v1"
	modelmetrics "github.com/acexy/proxy/pkg/metrics"
	"github.com/acexy/proxy/pkg/msg"
	"github.com/acexy/proxy/pkg/nathole"
	plugin "github.com/acexy/proxy/pkg/plugin/server"
	"github.com/acexy/proxy/pkg/ssh"
	...
	"github.com/acexy/proxy/pkg/util/tcpmux"
...
func NewService(cfg *v1.ServerConfig) (*Service, error) {
	...
	svr.listener = ln
	log.Infof("tcp listen on %s", address)
	...
	if cfg.KCPBindPort > 0 {
		...
		log.Infof("kcp listen on udp %s", address)
	}
	...
	if cfg.QUICBindPort > 0 {
		...
		log.Infof("quic listen on %s", address)
	}
	...
	if cfg.SSHTunnelGateway.BindPort > 0 {
		...
		log.Infof("sshTunnelGateway listen on port %d", cfg.SSHTunnelGateway.BindPort)
	}
